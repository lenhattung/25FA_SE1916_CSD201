...
public class MyList {
    ...
    void addFirst(String name, int price) {
        Node newNode = new Node(new Phone(name, price));
        if (isEmpty()) {
            head = tail = newNode;
        } else {
    ...
    void f3() throws Exception {
        ...
        Node temp = head;
        while (temp != null) {
            computeSum += temp.getInfo().getPrice();
            temp = temp.getNext();
        }
    ...
    void removePosition(int k) {
        if (!isEmpty()) {
            if (k == 0) {
                ...
                if (beforeK != null) {
                    beforeK.setNext(beforeK.getNext().getNext());
                }
            }
            size--;
        }
    ...
    void f4() throws Exception {
        ...
        if (!isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                if (maxPrice < temp.getInfo().getPrice()) {
                    maxPrice = temp.getInfo().getPrice();
                    maxPosition = i;
                }
                temp = temp.getNext();
            }
            removePosition(maxPosition);
        }
        //------ End your code here-----------------------------------------------------------
        //------------------------------------------------------------------------------------
        ftraverse(f);
    ...
    void f5() throws Exception {
        ...
        Node temp = head;
        while(temp!=null){
            if(temp.getInfo().getName().equals("S")){
                int price = temp.getInfo().getPrice();
                temp.getInfo().setPrice((int)(price*0.9));
            }
        }
        //------ End your code here-----------------------------------------------------------
        //------------------------------------------------------------------------------------
